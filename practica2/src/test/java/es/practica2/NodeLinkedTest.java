...
public class NodeLinkedTest<T>{
    ...
    @Nested
    @DisplayName("Tests dedicados a los constructores")
    ...
    //primera sesion (practica 2)
    @Nested
    @DisplayName("Tests dedicados a los Gets y los Sets")
    class GetYSeTest {
        @Test
    ...
    //primera sesion (practica 2)
    @Nested
    @DisplayName("Tests dedicados a la clase isFirstNode")
    ...
    //primera sesion (practica 2)
    @Nested
    @DisplayName("Tests dedicados a la clase isLastNode")
    ...
    //primera sesion (practica 2)
    @Nested
    @DisplayName("Tests dedicados a la clase isNotATerminalNode")
