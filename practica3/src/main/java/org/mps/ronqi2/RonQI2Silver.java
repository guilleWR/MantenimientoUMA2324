...
public class RonQI2Silver extends RonQI2{
    ...
    public RonQI2Silver() {
        ...
        thresholdS = 30.0f;
        numLecturas=5;
    } // Si devuelve un valor es un stub si es un cambio de estado es un mock
    ...
    */
    ...
    public boolean evaluarApneaSuenyo() {
        ...
        //error encontrado: avgP y avgS deben ser mayor o estricto y devolver true (antes era false)
